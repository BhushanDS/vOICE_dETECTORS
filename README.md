...
-  Detect and transcribe spoken commands or phrases. [ Implemented ]
     ...
     - So you Commands tag in congif.xml have exe and argument EX : ## <h3> <command text="Computer open youtube" path="chrome.exe" arguments="http://youtube.com" /> </h3>
     - And you choice tag should match to so for abouve Example : ## <h3> <choice>Computer open youtube</choice> </h3>
